...
def FileToMongoDeleteMatch():
    ...
    def delete_item():
        ...
        res = fileToMongoItem.delete_item(data_type_list[1])  # 0 competition, 1 match, 2 lineup, 3 event
        logging.info(f"delete_item :: res is ... {res}")

        return {"res": res, "data_type": data_type_list[1]}  # xcom push
